    ...
    timelineEvents: [
      {
        ...
        text: 'Each bar represents one of the 2000 most severe streamflow drought events measured at a USGS  streamgage. The taller the bar, the longer the drought.', // Narrative text
      },
      {
