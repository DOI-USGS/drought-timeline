export default {
    timelineEvents: [
      ...
      },
      {
        id: 'intro_narration',
        date: '1921-07-01',
        text: 'This timeline shows the 2,000 most severe streamflow drought events at USGS streamgages over 100 years (<a href="https://water.usgs.gov/vizlab/what-is-drought/" target="_blank">What is Streamflow Drought?</a>). Each bar shows the duration of drought at a single gage so that the taller and darker the bar, the longer the drought event. When multiple streamgages experienced drought conditions simultaneously, the chart is wider.',
